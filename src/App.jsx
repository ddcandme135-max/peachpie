...
function MobileDockGate() {
  ...
  const show = isMobile && (pathname === "/" || pathname === "/search" || pathname === "/search-results" || pathname === "/library" || pathname === "/new-songs" || pathname === "/recently-played" || pathname === "/for-you" || (onChat && !chatThreadOpen));
  if (!show) return null;
  return <MobileDock />;
}
...
function ConditionalMiniPlayer() {
  ...
  const isMobileDock = typeof window !== "undefined" && window.innerWidth < 768 && (pathname === "/" || pathname === "/search" || pathname === "/search-results" || pathname === "/library" || pathname === "/new-songs" || pathname === "/recently-played" || pathname === "/for-you");
