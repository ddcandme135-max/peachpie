...
import { CDCover, setSpinPlaying } from "./MobileHome";
...
export default function MobileDock() {
  ...
  // CD 회전 엔진 구동: 재생 중일 때만 각도 진행, 정지 시 그 자리에서 멈춤
  useEffect(() => { setSpinPlaying(isPlaying); }, [isPlaying]);
    ...
    <>
      ...
      <div style={{ position: "fixed", left: 12, right: 12, bottom: 14, zIndex: 100, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {currentTrack && collapsed && (
            <button onClick={() => setCollapsed(false)} aria-label="플레이어 펼치기" style={{ all: "unset", cursor: "pointer", width: 66, height: 66, borderRadius: 999, flex: "none", display: "grid", placeItems: "center", ...GLASS, border: "1px solid rgba(255,255,255,0.18)" }}>
